    ...
    <el-form class="func-command__form" :model="commandForm" ref="controlFormRef" :rules="formRules" label-width="auto">
      ...
      <div class="command-form__details" v-if="dynamicFields.showTypeData">
        ...
        <el-form-item label="密码" prop="pass">
          <el-input v-model="commandForm.pass" placeholder="密码" @input="handleLimitInput($event, 'pass', 4)"></el-input>
        </el-form-item>

        <el-form-item label="采集周期" class="func-command__group" prop="collect">
        ...
        <el-form-item label="定时报周期" class="func-command__group" prop="timer">
        ...
        <el-form-item label="定时报开始时间" prop="timer_start">
          <el-time-picker v-model="commandForm.timer_start" format="HH:mm" value-format="HH:mm" placeholder="定时报开始时间" />
        </el-form-item>

        <template class="func-command__check">
          <el-form-item label="自检上报参数" class="func-command__check-item" prop="check_time">
            <el-time-select v-model="commandForm.check_time" style="width: 100%" start="00:00" step="1:00" end="23:00"
              format="HH" placeholder="开始时刻" />
          </el-form-item>
          <el-form-item style="width: 115px; margin-left: 10px" prop="check_num">
            <el-input :model-value="commandForm.check_num" @input="handleExactDivisionInput($event, 'check_num')"
              placeholder="每天上报次数" />
          </el-form-item>
        </template>
        <!-- 泥位计 -->
        <template class="func-command__rain" v-if="type == 1">
          ...
          <el-form-item label="安装高度" class="func-command__group" prop="data.high">
            <el-input v-model="commandForm.data.high" @input="handleInput($event, 'high', 0, 0, 65)" placeholder="安装高度" />
            <div class="func-command__unit">m</div>
          </el-form-item>

          <el-form-item label="初始值" class="func-command__group" prop="data.origin">
            <el-input v-model="commandForm.data.origin" @input="handleInput($event, 'origin', 0, 0, 65)"
              placeholder="初始值" />
            <div class="func-command__unit">m</div>
          </el-form-item>

          <el-form-item label="加报阈值" class="func-command__group" prop="data.threshold">
        ...
        <template class="func-command__rain" v-if="type == 2">
          <el-form-item label="雨量计地址" prop="data.addr">
            <el-input v-model="commandForm.data.addr" maxlength="255" placeholder="雨量计地址" />
          </el-form-item>
          <el-form-item label="加报周期" class="func-command__group" prop="data.cycle">
            <el-input v-model="commandForm.data.cycle" @input="handleInput($event, 'cycle', 0, 1, 255)"
              placeholder="加报周期" />
            <div class="func-command__unit">min</div>
          </el-form-item>

          <el-form-item label="报警阈值" class="func-command__group" prop="data.threshold">
            <el-input v-model="commandForm.data.threshold" @input="handleInput($event, 'threshold', 0, 1, 1440)"
              placeholder="报警阈值" />
            <div class="func-command__unit">mm</div>
          </el-form-item>

          <el-form-item label="报警阈值时长" class="func-command__group" prop="data.the_time">
            <el-input v-model="commandForm.data.the_time" @input="handleInput($event, 'the_time', 0, 1, 255)"
              placeholder="报警阈值时长" />
            <div class="func-command__unit">min</div>
          </el-form-item>

          <el-form-item label="累计雨量" class="func-command__group" prop="data.sum">
      ...
      <el-form-item label="时间段" v-if="dynamicFields.showDateTimeRange" prop="data.dateTimeRange">
        <el-date-picker v-model="commandForm.data.dateTimeRange" type="datetimerange" range-separator="至"
          style="width: 100%" start-placeholder="开始时间" end-placeholder="结束时间" value-format="YYYY-MM-DD HH:mm:ss"
          :clearable="false" />
      </el-form-item>

      <el-form-item label="遥测站时钟" v-if="dynamicFields.showClock" prop="data.lock">
